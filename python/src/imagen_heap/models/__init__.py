...
REGISTRY: list[ModelEntry] = [
    ...
    ModelEntry(
        id="flux-dev-mflux-q8",
        name="FLUX.1-dev (mflux 8-bit)",
        version="1.0",
        architecture="flux",
        license_spdx="non-commercial",
        file_size_bytes=18_000_000_000,  # ~18 GB pre-quantized
        quantization="q8",
        min_memory_mb=16000,
        source_url="https://huggingface.co/dhairyashil/FLUX.1-dev-mflux-8bit",
        checksum_sha256="",
        is_default=False,
        description="High quality 25-step generation. Pre-quantized for fast native inference on Apple Silicon.",
        filename="flux1-dev-mflux-8bit",
        hf_repo_id="dhairyashil/FLUX.1-dev-mflux-8bit",
